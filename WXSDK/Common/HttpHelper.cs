...
namespace WXSDK.Common
{
    ...
    public class HttpHelper
    {
        ...
        private void SetCer(HttpItem item)
        {
            ...
            {
                //string uuu = "https://wx2.qq.com/cgi-bin/mmwebwx-bin/webwxsendmsg?pass_ticket=QG2NODyELvxinu2T%2BnWdIkFfQW2sR4DKJN59%2FvesZDSXTvhDiPJ4XVAusLZp3G%2FF";
                //初始化对像，并设置请求的URL地址   这里出错了
                request = (HttpWebRequest)WebRequest.Create(item.URL);
                SetCerList(item);
            }
        }
